                  ...
                  return const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16),
                        Text('No jobs available', style: TextStyle(color: Colors.grey)),
                      ],
                    ),
                  );
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _JobCard(
                      ...
                      salary: '\$${job['salary']?.toString() ?? '0'}/month',
                      country: job['country'] ?? '',
          ...
          children: [
            ...
            Row(
              children: [
                ...
                _Chip(Icons.directions_car, vehicleType),
                if (visa) ...[
                  const SizedBox(width: 8),
                  _Chip(Icons.flight, 'Visa'),
                ],
              ],
            ),
          ],
